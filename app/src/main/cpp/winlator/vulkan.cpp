...
Java_com_winlator_cmo_core_GPUInformation_getVersion(JNIEnv *env, jclass obj) {
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_winlator_cmo_core_GPUInformation_getRenderer(JNIEnv *env, jclass obj) {
    VkPhysicalDeviceProperties props = {};
    char *renderer;
    VkInstance instance;
...
Java_com_winlator_cmo_core_GPUInformation_getMemorySize(JNIEnv *env, jclass obj) {
...
Java_com_winlator_cmo_core_GPUInformation_enumerateExtensions(JNIEnv *env, jclass obj) {
